...
async function carregarCuponsLoja() {
    try {
        ...
        if (cupons.length === 0) {
            container.innerHTML = '<p>Nenhum cupom disponível na loja no momento.</p>';
            return;
        }
        ...
        document.getElementById('cupons-loja-container').innerHTML = '<p>Erro ao carregar os cupons.</p>';
    }
}
